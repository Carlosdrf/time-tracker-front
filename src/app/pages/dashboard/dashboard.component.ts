...
export class DashboardComponent implements OnInit {
  ...
  constructor(private socketService: WebSocketService, private dashboardService: DashboardService, public customDate: CustomDatePipe, private cdRef: ChangeDetectorRef, private page: PagesComponent){
