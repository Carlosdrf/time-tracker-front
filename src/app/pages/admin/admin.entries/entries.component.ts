...
export class EntriesComponent implements OnInit{
  ...
  constructor(private customDate: CustomDatePipe, private dashboardService: DashboardService, private router: Router, private reports: ReportsService){}
  ...
  getEntries(){
    ...
    this.dashboardService.getUsersEntries(user).subscribe((v)=>{
  ...
  public getEntryStatus(){
    ...
    this.dashboardService.getUserEntryStatus(user).subscribe((res)=>{
